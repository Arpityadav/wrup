        ...
        <div class="px-4 py-6 h-full">
            <div class="mx-auto max-w-5xl">
                <div class="flex items-center px-3 mb-4">
                    <h3 class="font-black text-gray-300">My boards</h3>
                    <Popover
                        v-slot="{ open }"
                        class="relative"
                    >
                        <PopoverButton
                            ...
                            class="focus:outline-none inline-flex items-center px-3 py-2 ml-4 font-medium text-gray-200 bg-indigo-700 rounded hover:bg-indigo-800 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                        >
                ...
                <ul class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    <li
                        ...
                        :key="board.id"
                        class="relative bg-gray-700 hover:bg-gray-600 rounded-md min-h-[7rem]"
                    >
                        <Link
